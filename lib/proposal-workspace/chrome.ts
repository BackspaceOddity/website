...
(function () {
  ...
  var ring=mk('div'); ring.style.cssText='position:fixed;pointer-events:none;z-index:9997;display:none;outline:2px solid var(--em-ring);outline-offset:2px;background:transparent;border-radius:4px;'; document.body.appendChild(ring);
