  ...
  saveBtn.addEventListener('click',function(){
...

    {
      ...
      before: {
        ...
        body:
          'Paid-данные — в BigQuery и Looker (Digital-команда собирает вручную под каждую кампанию). Органика и инфлюенсеры — в Sprout и Excel. Тикеты и итоги — в uTrack и Google Drive. Naming-конвенции работают непоследовательно. Сравнивать данные из этих источников сейчас невозможно — «тёплое с мягким».',
      },
      after: {
